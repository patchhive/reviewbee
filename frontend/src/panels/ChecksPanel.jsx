      ...
      <div style={{ ...S.panel, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
        <div>
          ...
          <div style={{ color: "var(--text-dim)", fontSize: 12 }}>
            ReviewBee needs local auth plus GitHub review access. This panel is the quick sanity check before you run it against a PR.
          </div>
        </div>
      ...
      {health && (
        <div style={{ ...S.panel, display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 18, fontWeight: 700, color: health.github_ready ? "var(--green)" : "var(--accent)" }}>
              {health.github_ready ? "yes" : "no"}
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div style={{ fontSize: 18, fontWeight: 700, color: "var(--accent)" }}>{health.open_item_count}</div>
          </div>
          <div>
